...
async def order(update:Update,context:ContextTypes.DEFAULT_TYPE) ->int:
    ...
    await update.message.reply_text(f"Уважаемый {context.user_data['full_name']}. "+translation[context.user_data['language']]['order_created'],reply_markup=ReplyKeyboardMarkup(manu_buttons,resize_keyboard=True))
    return MANU
